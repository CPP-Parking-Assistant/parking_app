...
public class ThanksActivity2 extends ActionBarActivity {
    @Override
    ...
    public void openSettings(){
        Intent intent = new Intent(ThanksActivity2.this,Settings.class);
        startActivity(intent);
    }
    public void goHome(){
        Intent intent = new Intent(ThanksActivity2.this,ParkingActivity.class);
        startActivity(intent);
    }
    public void exit(){
        this.finish();
